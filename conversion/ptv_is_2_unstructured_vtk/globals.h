...
#define nmax 65500 //61720 //20240 changed nmax due to problems with memory allocation at high values of particle detection
...
extern  int     Ptrackallocflag; /* checkflag if megaP, c4P, t4P already allocated */
...
extern  double	Pnpart[80];
extern  double	Pnlinks[80];
...
extern	unsigned char	*img[];			/* image data */ //changed to unsigned short due to work with 16 bit values
extern	unsigned short	*img16[];	    /*16 bit image data */
extern	unsigned char	*zoomimg;		/* zomm image data *///changed to unsigned short due to work with 16 bit values
...
extern  target          *c[4];
extern  target          *n[4];
extern  target          *t4[4][16];  /*t4[4frame-tracking][n_img]*/
extern  target          *t4P[12][4][16];  /*t4[4core][4frame-tracking][n_img]*/
extern  int             nt4[4][4];  /*nt4[4frame-tracking][n_img]*/
extern  int             nt4P[12][4][4];  /*nt4[4core][4frame-tracking][n_img]*/
extern  corres          *corrp;
extern  corres	       	*corrc;
extern  corres	       	*corrn;
extern  corres	       	*c4[4];
extern  corres	       	*c4P[12][4];
...
int  sequence_proc_c();
int  sequence_parallel_proc_c();
int sequence_proc_para_c ();
...
int  mouse_proc_c ();
void read_image();
void read_image_16bit ();
int  read_tiff ();
int  write_tiff ();
void copy_images();
void rescale_16bit_Img();
void subtract_mask();
void subtract_mask_gv();
...
int  find_track ();
int track_fuzzy_c ();
int EBC_parallel_track_fuzzy_c();
void rotate_parallel_dataset();
void write_added_parallel();
void write_ascii_data_parallel();
void read_ascii_data_parallel();
void reset_megaP_to_default();
double moduloP();
void reset_mega_to_default();
int trackcorr_c ();

int  candsearch_in_pix ();
int  streaky_candsearch_in_pix ();
int  candsearch_in_pixrest ();
int  streaky_candsearch_in_pixrest ();
int  calc_particle_optics_in_pix ();
double calc_spring_tension();
int  corrtest();
void predict();
...
void angle_acc();
void sortwhatfound();
void sortwhatfound_16points ();
void bubble_foundpix1 ();
void bubble_foundpix2 ();
void tclimg2cimg();
void cimg16uTotclimg();
